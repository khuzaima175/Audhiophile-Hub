  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/90 backdrop-blur-md p-2 md:p-4 animate-in fade-in duration-200 safe-area-top safe-area-bottom">
      ...
      {showComparison && (
        ...
        >
          <div
            className="bg-[#0A0A0A] w-full max-w-4xl rounded-2xl border border-audio-accent/30 shadow-2xl shadow-audio-accent/10 overflow-hidden animate-in zoom-in-95 flex flex-col max-h-[90vh]"
