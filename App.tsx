  ...
  return (
    <div className="flex h-screen h-screen-mobile bg-audio-base text-audio-text font-sans overflow-x-hidden overflow-y-hidden selection:bg-audio-accent selection:text-black touch-pan-all">
      ...
      <div className="flex-1 flex flex-col h-full relative">
        ...
        {/* Messages */}
        <div className="flex-1 overflow-y-auto p-4 md:p-8 space-y-2 scroll-smooth scroll-touch mobile-scroll-fix bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-[#101010] to-[#050505]" style={{ WebkitOverflowScrolling: 'touch', overscrollBehaviorY: 'contain' }}>
